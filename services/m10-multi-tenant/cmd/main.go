...
import (
	...
	"gpsgo/services/m10-multi-tenant/internal/config"
	"gpsgo/services/m10-multi-tenant/internal/handler"
...
func main() {
	...
	r.Get("/health", func(w http.ResponseWriter, _ *http.Request) {
		...
		_, _ = w.Write([]byte(`{"status":"ok","service":"m10-multi-tenant"}`))
	})
	...
	log.Printf("m10-multi-tenant listening on :%s", cfg.Port)
