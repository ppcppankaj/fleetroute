...
import (
	...
	"gpsgo/services/m13-security/internal/config"
	"gpsgo/services/m13-security/internal/handler"
	"gpsgo/services/m13-security/internal/kafka"
...
func main() {
	...
	r.Get("/health", func(w http.ResponseWriter, _ *http.Request) {
		...
		_, _ = w.Write([]byte(`{"status":"ok","service":"m13-security"}`))
	})
	...
	log.Printf("m13-security listening on :%s", cfg.Port)
