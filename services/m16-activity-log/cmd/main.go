...
import (
	...
	"gpsgo/services/m16-activity-log/internal/config"
	"gpsgo/services/m16-activity-log/internal/handler"
	"gpsgo/services/m16-activity-log/internal/kafka"
...
func main() {
	...
	r.Get("/health", func(w http.ResponseWriter, _ *http.Request) {
		...
		_, _ = w.Write([]byte(`{"status":"ok","service":"m16-activity-log"}`))
	})
	...
	log.Printf("m16-activity-log listening on :%s", cfg.Port)
