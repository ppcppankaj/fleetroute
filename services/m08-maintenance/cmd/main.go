...
import (
	...
	"gpsgo/services/m08-maintenance/internal/config"
	"gpsgo/services/m08-maintenance/internal/handler"
...
func main() {
	...
	r.Get("/health", func(w http.ResponseWriter, _ *http.Request) {
		...
		_, _ = w.Write([]byte(`{"status":"ok","service":"m08-maintenance"}`))
	})
	...
	log.Printf("m08-maintenance listening on :%s", cfg.Port)
